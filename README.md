...
- **Conversations Screen:** A central hub for all user chats.
- **Contacts Page:** A comprehensive list of user contacts.
- **Group Chat Page:** Functionality for group conversations.
